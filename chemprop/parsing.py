...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--val_data_path', type=str, default="",
                        help='支持指定数据集')
    parser.add_argument('--extra_test_path', type=str, default="",
                        help='支持多目标指定不同测试集')
    parser.add_argument('--extra_val_path', type=str, default="",
                        help='支持多目标指定不同验证集')
    parser.add_argument('--encoder_checkpoint_path', type=str, default="",
                        help='encoder_checkpoint_path')
    ...
    parser.add_argument('--multiclass_num_classes', type=int, default=2,
    ...
    parser.add_argument('--metric', type=str, default=None,
                        choices=['auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy','sp',"f1","mcc"],
    ...
    parser.add_argument('--multi_view',type=int, default=1,
                        help='multi_view')
...
def modify_train_args(args: Namespace):
    ...
    if not ((args.dataset_type == 'classification' and args.metric in ['auc', 'prc-auc', 'accuracy','sp',"f1","mcc"]) or
